...
import cc from '../assets2/logo.png';
import avatar from '../assets2/ava.jpg';
import ccicon from '../assets2/cc.png';
...
const Sidebar = () => {
  ...
  const Sidebar_Links = [
    ...
    { id: 2, path: '/opdq', name: "OPDQ", icon: FaStethoscope },
    { id: 3, path: '/bedalot', name: "BED allotment", icon: FaBed },
    { id: 4, path: '/notifications', name: "Notices", icon: MdInventory2 },
